...
bool DeckLinkInputDevice::startCapture(BMDDisplayMode displayMode, bool enable3D, BMDPixelFormat pixelFormat)
{
	...
	{
		std::cout << " Unable to get display Mode " << std::endl;
		return false;
	}
	...
	{
		printf("Unable to enable video input");
		return false;
	}
	...
	{
		printf("Unable to start streams\n");
		return false;
	}
